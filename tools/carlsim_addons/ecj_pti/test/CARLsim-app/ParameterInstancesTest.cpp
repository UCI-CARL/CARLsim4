...
TEST_F(ParameterInstancesTest, Constructor) {
    EXPECT_EQ(sut.getNumIndividuals(), 4) << "Constructor deduced incorrect number of rows.";
...
TEST_F(ParameterInstancesTest, EmptyInput) {
    ...
    EXPECT_EQ(sut.getNumIndividuals(), 0) << "Found data here, but the input was empty.";
