...
#python3 setup.py build_ext -b ./bin/ -t ./bin/wrap --define __CUDA9__ --include <CARLSIM_INSTALL_DIR>/CARL/include:/usr/local/cuda/include:/usr/local/cuda/samples/common/inc
