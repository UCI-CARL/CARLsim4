...
%(TIME) and neuron IDs (NIDS), and converts to a FULL representation. Indexing
%in the input should start at 0, and will be converted to start at 1.
%   time:       all spike times
%   nIDs:       all neuron IDs
%   frameDur:   frame duration, ms per stim period (default 1000)
%   dim:        [max limit of TIME, max limit of NIDS]. If omitted, extract from
%               input params
%
% Ver 05/31/12
