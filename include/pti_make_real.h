...
/* Kris Carlson 10/31/2011
   ...
   pti_eoEasyEA object.  This file is for the ES objects: eoReal.
 */
//-----------------------------------------------------------------------------
...
eoModlibAlgo<eoReal<double> >&  pti_make_algo_scalar(eoParser& _parser, eoState& _state, eoEvalFunc<eoReal<double> >& _eval, eoContinue<eoReal<double> >& _ccontinue, eoGenOp<eoReal<double> >& _op, eoDistance<eoReal<double> >* _dist = NULL);

eoModlibAlgo<eoReal<eoMinimizingFitness> >&  pti_make_algo_scalar(eoParser& _parser, eoState& _state, eoEvalFunc<eoReal<eoMinimizingFitness> >& _eval, eoContinue<eoReal<eoMinimizingFitness> >& _ccontinue, eoGenOp<eoReal<eoMinimizingFitness> >& _op, eoDistance<eoReal<eoMinimizingFitness> >* _dist = NULL);
