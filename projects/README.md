Please find below a previous version of the Hippocampome-CARLsim simulation framework. The newest version of the framework, which utilizes CARLsim6, can be found [here](https://github.com/jkopsick/CARLsim6/tree/feat/CS6_hc_ca3/projects).
