...
/// **************************************************************************************************************** ///
/// CORE IMPLEMENTATION TESTS: Tests core functionality of *some* key CARLsim functions
/// **************************************************************************************************************** ///

/*!
 * \brief tests valid CpuSNN instantiation.
 * Tests CpuSNNInit with all possible (valid) ways of instantiation.
 */
...
/*!
 * \brief tests invalid CpuSNN instantiation.
 * Tests CpuSNNInit with invalid instantiation calls.
 * 
...
/*!
 * \brief tests invalid createGroup values.
 * Tests invalid createGroup function calls with silly values.
 */
...
/*!
 * \brief tests invalid createSpikeGenerator values.
 * Tests invalid createSpikeGenerator function calls with silly values.
 */
...
/*!
 * \brief tests invalid setNeuronParameters values.
 * Tests invalid setNeuronParameters function calls with silly values.
 */
...
/*!
 * \brief tests for synaptic conductance ratios.
 * Uses connect with certain mulSynFast/mulSynSlow parameter values and
 * observes connectInfo values.
 *
